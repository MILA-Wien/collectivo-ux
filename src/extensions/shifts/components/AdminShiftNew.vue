...
<template>
  <PrimeDialog
    ...
    :header="t('Add shift') + ' ' + newShift.shift_title"
    id="add-shift-dialog"
  ...
  >
    <div class="dialog-content row">
      ...
      <div
        v-if="newShift.shift_type === 'repeating_monthly'"
        class="field col-12"
      >
      ...
      <div
        v-if="
          newShift.shift_type === 'repeating_monthly' ||
          newShift.shift_type === 'repeating_weekly'
        "
        class="field col-12"
      >
